...
export function renderMemePage(
  ...
  const suggestionSection = safeSuggestionFormUrl
    ? `<nav class="actions page-end-actions" aria-label="Запропонувати свій мем">
  ...
  return documentShell({
    ...
    body: `<main class="shell">
      ...
      <p class="author-credit">Автор: <a href="${escapeHtml(meme.ownerUrl)}" target="_blank" rel="noopener noreferrer">${escapeHtml(ownerUsername)}</a></p>
